...
_.partition = (array, action) => [_.filter(array, action), _.reject(array, action)];
...
// indexOf takes array and value; returns index of first instance of value; if no value, -1
...
_.contains = function(array, value){
   ...
   //if value exists, iterate over array to see if element equals value. If it does return true
   //if not return false.
